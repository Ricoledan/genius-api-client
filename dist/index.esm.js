...
var _spec = "axios";
var _where = "/mnt/c/Users/ricol/dev/projects/genius-api-client";
var author = {
	name: "Matt Zabriskie"
};
var browser$1 = {
...
function config (options /*: ?DotenvConfigOptions */) /*: DotenvConfigOutput */ {
  ...
  try {
    ...
    const parsed = parse$1(fs.readFileSync(dotenvPath, { encoding }), { debug });
...
function getAllSongDetails(response) {
  let i;
  const obj = [];
...
const getArtistIdDetails = name => HTTPClient({
  url: 'search',
  params: {
    q: `${name}`,
    text_format: 'plain'
...
export { getArtistDetails, getArtistIdDetails, getSongDetails };
